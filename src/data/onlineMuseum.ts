...
const digitalLandscapeHalls: Hall[] = [
  {
    ...
    exhibits: [
      ...
      },
      {
        ...
        image: '/images/苏州山水全图卷/ren_02.jpg',
        alt: '山径拾级',
        material: 'Digital Painting',
        period: '2024',
        order: 3,
  ...
  },
  {
    ...
    exhibits: [
      ...
      },
      {
        ...
        image: '/images/苏州山水全图卷/ren_05.jpg',
        alt: '渔村日常',
        material: 'Digital Painting',
        period: '2024',
        order: 3,
      ...
      },
      {
        ...
        image: '/images/苏州山水全图卷/ren_06.jpg',
        alt: '街市',
        material: 'Digital Painting',
        period: '2024',
        order: 4,
...
const tianlongshanHalls: Hall[] = [
  {
    ...
    atmosphereImage: '/images/天龙山石窟/tls1.jpg',
  ...
  },
  {
    ...
    atmosphereImage: '/images/天龙山石窟/tls2.jpg',
...
const tianlongshanExhibition: Exhibition = {
  ...
  preface:
    '凝视 · 离散 · 重构\n天龙山石窟造像的数字归乡。\n在凝视厅，与唐人雕凿的面孔四目相对，感受石头里尚存的体温；\n在离散厅，目睹被凿离故土的残件如何漂泊异乡；\n在重构厅，见证数据如何让破碎重归完整，让石窟在0与1之间复得其魂。',
  prefaceEn:
...
const beiqiMuralHalls: Hall[] = [
  {
    ...
    atmosphereImage: '/images/北齐壁画博物馆/bq3.jpg',
  ...
  },
  {
    ...
    atmosphereImage: '/images/北齐壁画博物馆/bq2.jpg',
...
const beiqiMuralExhibition: Exhibition = {
  ...
  preface:
    '仪仗 · 骏马 · 矿物\n北齐墓室壁画的三重凝视。\n仪仗厅里，你随浩荡的出行队伍穿越千年；\n骏马厅中，神骏的鼻息仍携带着墓室的幽暗气息；\n矿物厅内，色彩与时间共谋的裂纹成为最动人的叙事。',
  prefaceEn:
...
const arMuseumHalls: Hall[] = [
  {
    ...
    atmosphereImage: '/images/体乐里体育博物馆/图片.jpg',
    ...
    exhibits: [
      ...
      },
      {
        ...
        image: '/images/体乐里体育博物馆/图片 (2).jpg',
        alt: 'AR 角色与身份证锚点',
  ...
  },
  {
    ...
    atmosphereImage: '/images/体乐里体育博物馆/图片 (1).jpg',
  ...
  },
  {
    ...
    atmosphereImage: '/images/体乐里体育博物馆/图片 (2).jpg',
...
const arMuseumExhibition: Exhibition = {
  ...
  preface:
    '书画 · 器物 · 体验\n中国古代体育史的AR重启。\n从文献到器物，从图像到动作，我们将静止的展柜打开，用增强现实让文物回到它们被使用、被凝视、被赋予生命的那个瞬间。应用入口即是时空之门。',
  prefaceEn:
    ...
    exhibits: [
      {
        id: 'GS-01',
        title: '新芽 · 主视觉',
        titleEn: 'New Shoot · Key Visual',
        caption: '展览主视觉开场视频',
        captionEn: 'Exhibition key visual opening',
      ...
      },
      {
        id: 'GS-02',
        title: '新芽 · 现场 01',
        titleEn: 'New Shoot · Site 01',
        image: '/images/Green Shoots of arts/IMG_8580.JPEG',
        alt: 'Green Shoots of arts 展览现场 01',
        material: 'Exhibition Photo',
        period: '2024',
        order: 2,
        hallId: 'gs-hall-01',
      },
      {
        id: 'GS-03',
        title: '新芽 · 现场 02',
        titleEn: 'New Shoot · Site 02',
        image: '/images/Green Shoots of arts/IMG_8587.JPEG',
        alt: 'Green Shoots of arts 展览现场 02',
        material: 'Exhibition Photo',
        period: '2024',
        order: 3,
        hallId: 'gs-hall-01',
      },
      {
        id: 'GS-04',
        title: '新芽 · 现场 03',
        titleEn: 'New Shoot · Site 03',
        image: '/images/Green Shoots of arts/IMG_8599.JPEG',
        alt: 'Green Shoots of arts 展览现场 03',
        material: 'Exhibition Photo',
        period: '2024',
        order: 4,
        hallId: 'gs-hall-01',
      },
      {
        id: 'GS-05',
        title: '新芽 · 现场 04',
        titleEn: 'New Shoot · Site 04',
        image: '/images/Green Shoots of arts/IMG_8601.JPEG',
        alt: 'Green Shoots of arts 展览现场 04',
        material: 'Exhibition Photo',
        period: '2024',
        order: 5,
        hallId: 'gs-hall-01',
      },
      {
        id: 'GS-06',
        title: '新芽 · 现场 05',
        titleEn: 'New Shoot · Site 05',
        image: '/images/Green Shoots of arts/IMG_8628.JPEG',
        alt: 'Green Shoots of arts 展览现场 05',
        material: 'Exhibition Photo',
        period: '2024',
        order: 6,
        hallId: 'gs-hall-01',
      },
      {
        id: 'GS-07',
        title: '新芽 · 现场 06',
        titleEn: 'New Shoot · Site 06',
        image: '/images/Green Shoots of arts/IMG_8636.JPG',
        alt: 'Green Shoots of arts 展览现场 06',
        material: 'Exhibition Photo',
        period: '2024',
        order: 7,
        hallId: 'gs-hall-01',
      },
      {
        id: 'GS-08',
        title: '新芽 · 现场 07',
        titleEn: 'New Shoot · Site 07',
        image: '/images/Green Shoots of arts/IMG_8639.JPEG',
        alt: 'Green Shoots of arts 展览现场 07',
        material: 'Exhibition Photo',
        period: '2024',
        order: 8,
        hallId: 'gs-hall-01',
      },
      {
        id: 'GS-09',
        title: '新芽 · 现场 08',
        titleEn: 'New Shoot · Site 08',
        image: '/images/Green Shoots of arts/IMG_8643.JPEG',
        alt: 'Green Shoots of arts 展览现场 08',
        material: 'Exhibition Photo',
        period: '2024',
        order: 9,
        hallId: 'gs-hall-01',
      },
      {
        id: 'GS-10',
        title: '新芽 · 现场 09',
        titleEn: 'New Shoot · Site 09',
        image: '/images/Green Shoots of arts/IMG_8647.JPEG',
        alt: 'Green Shoots of arts 展览现场 09',
        material: 'Exhibition Photo',
        period: '2024',
        order: 10,
        hallId: 'gs-hall-01',
      },
      {
        id: 'GS-11',
        title: '新芽 · 现场 10',
        titleEn: 'New Shoot · Site 10',
        image: '/images/Green Shoots of arts/IMG_8690.JPEG',
        alt: 'Green Shoots of arts 展览现场 10',
        material: 'Exhibition Photo',
        period: '2024',
        order: 11,
        hallId: 'gs-hall-01',
...
const greenShootsExhibition: Exhibition = {
  ...
  preface:
    '在种子与土壤之间，在萌发与绽放之间。\n艺术以自身的方式生长。Green Shoots of arts 以「新芽」为题，将生长的过程本身作为展品，等待它们破土、向光、成林。',
  prefaceEn:
...
const weingreenHalls: Hall[] = [
  {
    ...
    atmosphereImage: '/images/The Weingreen Museum/首图.jpg',
    ...
    exhibits: [
      {
        ...
        image: '/images/The Weingreen Museum/首图.jpg',
...
const weingreenExhibition: Exhibition = {
  ...
  preface:
    'The Weingreen Museum of Biblical Antiquities 的数字迁移。\n我们将一组馆藏连同其策展逻辑一同搬入屏幕，让古老的叙事在新的介质中获得第二次生命。',
  prefaceEn:
